package com.example.individual.configuration.security.isAuthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.example.individual.configuration.security.isAuthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.example.individual.configuration.security.isAuthenticated.IsAuthenticated)")
